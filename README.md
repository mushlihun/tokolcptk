...
- 👉 Heroku : [https://tokolcptk.herokuapp.com](https://tokolcptk.herokuapp.com)
- 👉 AWS : [https://tokolcptk.webacademy.pro](https://tokolcptk.webacademy.pro)
...
```
$ git clone https://github.com/mushlihun/tokolcptk.git
$ cd tokolcptk
```
...
```
MONGODB_URL=mongodb://localhost/tokolcptk
...
- Q/A: https://mushlihun.github.io
- Contact Instructor: [Lihun](mailto:mushlihun@live.com)
...
1. Create Folder Structure
   1. create root folder as tokolcptk
   2. add frontend and backend folder
   3. create src folder in frontend
   4. create index.html with heading tokolcptk in src
...
6. Create Node.JS Server
   1. run npm init in root tokolcptk folder
...
44. Publish heroku
    ...
    4. heroku login
    5. heroku apps:create <yourname>tokolcptk
